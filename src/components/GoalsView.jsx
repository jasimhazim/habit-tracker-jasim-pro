...
export default function GoalsView() {
  ...
  const updateGoal = useCallback(async (catId, periodId, val) => {
    ...
    setGoals(next);
    try { await window.storage?.set(goalsKey, JSON.stringify(next)); } catch (e) {}
  }, [goals, goalsKey]);
    ...
    <div className="fade-up-2 ar-text">
      ...
      <div style={{ 
        ...
        <div style={{ position: 'absolute', top: 16, left: 16, zIndex: 10 }}>
          <div style={{ fontSize: 12, color: '#a1a1aa', fontWeight: 600, textTransform: 'uppercase', letterSpacing: 1 }}>Q1 Progress</div>
          <div style={{ fontSize: 24, fontWeight: 800, color: '#fff', fontFamily: "'JetBrains Mono'" }}>85%</div>
        </div>
                  ...
                  <div key={period.id}>
                    ...
                    <textarea
                      style={{
                        ...
                        color: "#fff", fontFamily: "'Tajawal', sans-serif", fontSize: 14, padding: "10px 12px",
                        borderRadius: 10, outline: "none", marginTop: 6, resize: "none", direction: "rtl", lineHeight: 1.5,
