  ...
  return (
    <div
      ...
      style={{
        ...
        background:
          "radial-gradient(circle at top right, rgba(99,102,241,0.15) 0%, #09090b 50%, #000000 100%)",
        padding: 20,
      }}
    >
      <div
      ...
      >
        ...
        >
          ...
          <p style={{ color: "#a1a1aa", fontSize: 16, margin: 0 }}>
            {isLogin
              ? "قم بتسجيل الدخول للوصول إلى لوحة القيادة الذكية."
              : "أنشئ حسابك لتجربة قوة المساعد الذكي."}
          </p>
        </div>
