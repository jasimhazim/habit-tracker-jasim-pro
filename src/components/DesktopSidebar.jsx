...
export default function DesktopSidebar() {
      ...
      >
        ...
        >
          <div style={{ color: "#e4e4e7" }}>
            <span style={{ color: "#71717a", fontSize: 11, marginRight: 6 }}>
              CURRENT
            </span>
            {value}
          </div>
  ...
  return (
    <div
      className="desktop-card fade-up ar-text"
      style={{ display: "flex", flexDirection: "column" }}
    >
      <h2 className="desktop-card-title">
        <Target color="#f4f4f5" size={24} /> الأهداف الاستراتيجية
      </h2>
        ...
        {["health", "fin", "edu"].map((catId, idx) => {
          ...
          return (
            <div
              key={catId}
              style={{
                marginBottom: idx === 2 ? 0 : 16,
                paddingBottom: idx === 2 ? 0 : 16,
                borderBottom:
                  idx === 2 ? "none" : "1px solid rgba(255,255,255,0.05)",
              }}
            >
              <div
                style={{
              ...
              >
                <div
                  style={{
                    ...
                    height: 8,
                    borderRadius: "50%",
                    background: colors[catId],
                    boxShadow: `0 0 8px ${colors[catId]}`,
                  }}
                />
                <div
                  style={{ fontSize: 13, color: "#a1a1aa", fontWeight: 700 }}
                >
                  {titles[catId]}
                </div>
              </div>
